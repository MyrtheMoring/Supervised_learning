# -*- coding: utf-8 -*-
"""
Created on Wed Feb  6 15:32:25 2019
...
hyperSVM(X_train, y_train, X_val, y_val,title="Model Complexity Curve for SVM (German Credit Data)\nHyperparameter : Kernel function")

opt_kernel, opt_C, opt_gamma= SVMRandomSearchCV(X_train,y_train)

estimator_final = SVC(kernel='linear', gamma = 'auto',C= 10, random_state=100)

title = "Learning Curves (SVM) - German Credit Data"

final_classifier_results(estimator_final, X_train, X_test, y_train, y_test)

plot_learning_curve(estimator_final, title, X, y, ylim=(0.3, 1.01), cv=5)